				...
				<div class="row">
					<div class="col-lg-12">
							...
							<div class="panel-body">
                                <div class="table-responsive" style="overflow: auto; width: auto; height: 350px">
                                    <table class="table table-striped table-bordered table-hover" id="data">
										...
										$query = "SELECT pvid, perfil, nome_servico, download, conectado, finalizado, servico_disp FROM servicos INNER JOIN dispositivos ON servicos.dispositivo = dispositivos.pvid WHERE servicos.download = 'N' AND dispositivos.user = '$email' ORDER BY idservicos";
						...
						<form method="post" action="liballserv.php">
							<button type="submit" class="btn btn-primary">Liberar Serviços para Download</button>
						</form>
					</div>
					<!-- /.col-lg-1 -->
...
document.querySelector("#data tbody").addEventListener("click", function(event) {
  ...
  if (td === this) {
	  ...
	  var data_rows = td.innerHTML;
            ...
            $form = $('<form/>').attr({method: 'POST', action: 'libserv.php'}).hide();
            //build textarea HTML
...
<meta HTTP-EQUIV='refresh' CONTENT='10;URL=run.php'>
