							...
							<div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
										...
										$query = "SELECT pvid, user, senha, nome, conectado, servicos, DHCP_ip, DHCP_mascara, DHCP_gateway, DHCP_dns, usou_dhcp FROM dispositivos WHERE user = '$email' ORDER BY pvid";
